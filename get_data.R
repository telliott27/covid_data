...
state_pops <- read_csv(here("data", "state_populations.csv"))

nyt_state_df <- read_csv("https://raw.githubusercontent.com/nytimes/covid-19-data/master/us-states.csv")
...
save.image(here("data", "covid_data.Rdata"))
